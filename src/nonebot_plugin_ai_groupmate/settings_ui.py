...
SETTING_GROUPS: tuple[tuple[str, str, tuple[str, ...]], ...] = (
    ...
    (
        ...
        (
            ...
            "agent_max_concurrency_per_group",
...
_DIRECT_LABELS = {
    ...
    "global_model_daily_private_user_limit_enabled": "启用每人每日私聊公共模型额度",
    "global_model_daily_private_user_limit": "每人每日私聊公共模型额度（0 为不限）",
    ...
    "agent_max_parallel_tools": "单轮安全工具并发上限",
